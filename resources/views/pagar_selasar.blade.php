                                ...
                                <table class="table table-striped nowrap" id="dt-table-apar">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Tanggal Input</th>
                                            <th>Ruangan</th> 
                                            <th>Tangga (Tidak terdapat lubang)</th>
                                            <th>RAM (Tidak terdapat Lubang, Kebersihan, karat, kebersihan)</th>
                                            <th>Keterangan</th>
                                            <th>Tindak Lanjut</th>
                                            <th>Input At</th>
                                            <th>Input By</th>
...
<!-- Modal Content Code -->
<div class="modal fade" tabindex="-1" id="modalFormPagarSelasar">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-validate is-alter" id="form-data-apar">
                    @csrf
                    <input type="hidden" name="id_index_pagar_selasar" id="id_index_pagar_selasar">
                    ...
                    <div class="form-group">
                        <div class="col-lg-12">
                            <label class="form-label">Tanggal (Tidak terdapat lubang)</label>
                        </div>
                            ...
                            <ul class="custom-control-group g-3 align-center flex-wrap">
                                <li>
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" name="tangga" value="baik" id="tangga_baik" required>
                                        <label class="custom-control-label" for="tangga_baik">Baik</label>
                                    </div>
                                </li>
                                <li>
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" name="tangga" value="tidak baik" id="tangga_tidak_baik" required>
                                        <label class="custom-control-label" for="tangga_tidak_baik">Tidak Baik</label>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-lg-12">
                            <label class="form-label">RAM (Tidak terdapat Lubang, Kebersihan, karat, kebersihan)</label>
                        </div>
                        ...
                        <div class="col-lg-7">
                            <ul class="custom-control-group g-3 align-center flex-wrap">
                                <li>
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" name="ram" value="baik" id="ram_baik" required>
                                        <label class="custom-control-label" for="ram_baik">Baik</label>
                                    </div>
                                </li>
                                <li>
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" name="ram" value="tidak baik" id="ram_tidak_baik" required>
                                        <label class="custom-control-label" for="ram_tidak_baik">Tidak Baik</label>
                                    </div>
                                </li>
                            </ul>
                        </div>
