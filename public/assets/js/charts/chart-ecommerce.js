...
!function (NioApp, $) {
  ...
  // chat session report (default inisialisasi aku disable)
  $.ajax({
    url: base_url + "/getSessionReport",
    method: "GET",
    dataType: 'json',
    success: function(res) {
      ecommerceLineS4('.sessionReport', res.data);

      // display legend
      res.legend.forEach(function(l) {
        $('.legendSessionReport').append(l);
      })
    }
  })
  ...
  // chat detail template (default inisialisasi aku disable)
